...
data class QuizPlayLaunchConfig(
...
enum class QuizPlayMode(val wireValue: String) {
    AllAtOnce("all_at_once"),
    OneByOne("one_by_one"),
}

enum class QuizTimerScope(val wireValue: String) {
    PerQuestion("per_question"),
    Total("total"),
}

enum class QuizPlayType(val wireValue: String) {
    First("first"),
    RetryAll("retry_all"),
