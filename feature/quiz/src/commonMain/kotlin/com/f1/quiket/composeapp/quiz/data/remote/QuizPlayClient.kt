...
internal class QuizPlayClient(
    ...
    suspend fun getQuizSession(
        ...
        return response.decodeQuizData<QuizSessionDataResponse>(
            missingMessage = "퀴즈 응답에 데이터가 없습니다.",
            failureMessage = "퀴즈 정보를 불러오지 못했습니다.",
            dataFailureMessage = "퀴즈 응답을 해석하지 못했습니다.",
        ).toDomain()
    }
    ...
    suspend fun createQuizSession(
        ...
        return response.decodeQuizData<QuizGenerationAcceptedDataResponse>(
            missingMessage = "퀴즈 생성 응답에 데이터가 없습니다.",
            failureMessage = "퀴즈 생성을 시작하지 못했습니다.",
            dataFailureMessage = "퀴즈 생성 응답을 해석하지 못했습니다.",
        ).toDomain()
    }
    ...
    suspend fun getQuizScope(
        ...
        return response.decodeQuizData<QuizScopeDataResponse>(
            missingMessage = "퀴즈 범위 응답에 데이터가 없습니다.",
            failureMessage = "퀴즈 범위를 불러오지 못했습니다.",
            dataFailureMessage = "퀴즈 범위 응답을 해석하지 못했습니다.",
        ).toDomain()
    }
    ...
    suspend fun getQuizGenerationStatus(
        ...
        return response.decodeQuizData<QuizGenerationStatusDataResponse>(
            missingMessage = "퀴즈 생성 상태 응답에 데이터가 없습니다.",
            failureMessage = "퀴즈 생성 상태를 확인하지 못했습니다.",
            dataFailureMessage = "퀴즈 생성 상태 응답을 해석하지 못했습니다.",
        ).toDomain()
    }
    ...
    suspend fun submitQuizResult(
        ...
        return response.decodeQuizData<QuizResultDataResponse>(
            missingMessage = "결과 응답에 데이터가 없습니다.",
            failureMessage = "퀴즈 결과를 제출하지 못했습니다.",
    ...
    private suspend fun HttpResponse.toPlaySession(
        defaultErrorMessage: String,
    ): QuizPlaySession = decodeQuizData<QuizPlaySessionDataResponse>(
        missingMessage = "풀이 세션 응답에 데이터가 없습니다.",
        failureMessage = defaultErrorMessage,
        dataFailureMessage = "풀이 세션 응답을 해석하지 못했습니다.",
    ).toDomain()

    private suspend inline fun <reified T> HttpResponse.decodeQuizData(
