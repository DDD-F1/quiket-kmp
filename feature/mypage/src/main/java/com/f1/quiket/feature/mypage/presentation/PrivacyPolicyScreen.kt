...
fun PrivacyPolicyScreen(
    ...
    val sections = remember { PrivacyPolicyRawText.toTermsSections() }
    val title = remember { PrivacyPolicyRawText.lines().firstOrNull().orEmpty() }
...
private val PrivacyPolicyRawText = """
개인정보처리방침
제1조 (목적)
퀴켓(Quiket)(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.
제2조 (개인정보 처리의 원칙)
...
수집목적: 소셜 로그인을 통한 회원 식별 및 간편 가입·로그인
수집정보: 소셜 로그인 식별자(소셜 계정 고유 ID, 이메일, 프로필 정보)
제9조 (개인정보 수집 방법)
...
이용자가 업로드한 학습 콘텐츠를 활용하여 서비스 품질을 개선하고 AI 모델을 학습·고도화하기 위한 경우(이 경우 회사는 개인을 식별할 수 없도록 비식별·익명 처리한 형태로 활용합니다)
제11조 (개인정보의 처리 위탁)
회사는 원활한 서비스 제공과 효과적인 업무를 처리하기 위하여 다음 각 호와 같이 개인정보를 처리 위탁하고 있습니다.
Amazon Web Services, Inc.(AWS)에게 서버 호스팅·데이터 보관을 위하여 회원 탈퇴 시 또는 위탁 계약 종료 시까지 동안 개인정보처리를 위탁함
Groq, Inc.에게 AI 기반 학습 콘텐츠 파트 분류 및 퀴즈 생성 처리를 위하여 회원 탈퇴 시 또는 위탁 계약 종료 시까지 동안 개인정보처리를 위탁함
Google LLC(Gemini)에게 업로드 콘텐츠의 OCR 및 텍스트 추출 처리를 위하여 회원 탈퇴 시 또는 위탁 계약 종료 시까지 동안 개인정보처리를 위탁함
Microsoft Corporation(Azure)에게 AI 기반 콘텐츠 처리를 위하여 회원 탈퇴 시 또는 위탁 계약 종료 시까지 동안 개인정보처리를 위탁함
...
이용자 및 법정 대리인은 자신의 가입정보 수집 등에 대한 동의를 철회하기 위해서는 개인정보보호책임자 또는 담당자에게 서면 또는 전자우편주소로 연락하시면 회사는 지체 없이 조치하겠습니다.
제20조 (개인정보 정보변경 등)
...
회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를 위반하는 사항을 내용으로 하는 국제계약을 체결하지 않습니다.
회사는 다음과 같이 개인정보를 국외로 이전(처리위탁)하고 있습니다.
Amazon Web Services, Inc. / 이전 국가: 미국 / 이전 목적: 서버 호스팅·데이터 보관 / 이전 항목: 제5조 내지 제8조의 수집 항목, 업로드 학습 콘텐츠 / 이전 일시 및 방법: 서비스 이용 시점에 정보통신망을 통한 전송 / 보유·이용기간: 회원 탈퇴 시 또는 위탁 계약 종료 시까지
Groq, Inc. / 이전 국가: 미국 / 이전 목적: AI 기반 파트 분류 및 퀴즈 생성 / 이전 항목: 업로드 학습 콘텐츠 / 이전 일시 및 방법: 서비스 이용 시점에 정보통신망을 통한 전송 / 보유·이용기간: 회원 탈퇴 시 또는 위탁 계약 종료 시까지
Google LLC / 이전 국가: 미국 / 이전 목적: OCR 및 텍스트 추출 / 이전 항목: 업로드 학습 콘텐츠 / 이전 일시 및 방법: 서비스 이용 시점에 정보통신망을 통한 전송 / 보유·이용기간: 회원 탈퇴 시 또는 위탁 계약 종료 시까지
Microsoft Corporation / 이전 국가: 미국 / 이전 목적: AI 기반 콘텐츠 처리 / 이전 항목: 업로드 학습 콘텐츠 / 이전 일시 및 방법: 서비스 이용 시점에 정보통신망을 통한 전송 / 보유·이용기간: 회원 탈퇴 시 또는 위탁 계약 종료 시까지
