...
internal enum class SignUpTermsDetailType {
    Service,
    Privacy,
}

internal data class SignUpTermsDetailContent(
    val title: String,
    val body: String,
)

internal fun SignUpTermsDetailType.toContent(): SignUpTermsDetailContent {
    val rawText = when (this) {
        SignUpTermsDetailType.Service -> ServiceTermsRawText
        SignUpTermsDetailType.Privacy -> PrivacyPolicyRawText
    }
